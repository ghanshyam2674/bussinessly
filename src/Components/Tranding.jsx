...
const Tranding = () => {
    return (
        <div className="max-w-[400px] flex gap-x-[15px] justify-center">
            <span className='text-[32px] font-[500] opacity-40'>01</span>
            <div className="flex flex-col gap-y-[5px]">
                ...
                <h1 className='text-[16px] font-[600]'>A Cheat Sheet and Some Recipes For Building Advanced RAG</h1>
                <div className="w-[118px] flex justify-between text-[12px] opacity-80">
                    <p>akbarh </p><p>.</p>
                    <p>June 28, 2021</p>
                </div>
            </div>
